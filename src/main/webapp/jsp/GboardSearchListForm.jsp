				...
				<div class="board_wrap">
					...
					<div class="board_list_wrap">
						<div class="board_list">
							...
							<div>
							<c:set var="listSize" value="${GboardSearchDTOList.size()}"></c:set>
							<c:forEach var="gboardDTO" items="${GboardSearchDTOList}" varStatus="stat">
						...
						<c:if test="${pn1 eq 'a'}">
							<a href="${webapproot}/gboardsearchlistform.do?pageNumber=${pageNumber-1}" class="bt prev"><</a>
						</c:if>
						<c:if test="${pn2 eq 'b' }">
							<a href="${webapproot}/gboardsearchlistform.do?pageNumber=${pageNumber+1}" class="bt next">></a>
						</c:if>
						</div>
						<div class="bt_wrap">
