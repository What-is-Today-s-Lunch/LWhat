	...
	<div class="main_text0" style="height: 830px">
      ...
      <div class="contents2">-->
		...
		<div class="board_wrap">
			...
			<form method="post" action="${webapproot}/qboardupdateproc.do">
				<input type="hidden" name="qPostingID" value="${qPostingID}" />
				<div class="board_write_wrap">
						<div class="board_write">
							<div class="title">
								<dl>
									<dt>제목</dt>
									<dd><textarea name="title" rows="1" cols="80">${qboardDTO.title}</textarea></dd>
									<dd> 아이디 : "${qbaordDTO.qPostingID}" </dd>
								</dl>
							...
							<div class="cont">
								<textarea name="content" rows="10" cols="80">${qboardDTO.content}</textarea>
							</div>
						</div>
					
						<div class="bt_wrap">
							<input type="submit" value="글수정하기" />
							<a href="${webapproot}/qboardview.do?qPostingID=${qboardDTO.qPostingID}">취소</a>
						</div>
					</div>
			</form>
		</div>
