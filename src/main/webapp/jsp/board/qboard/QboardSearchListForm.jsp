		...
		<div class="board_wrap">
			...
			<div class="board_list_wrap">
				<div class="board_list">
					...
					<div>
						<c:set var="listSize" value="${QboardSearchDTOList.size()}"></c:set>
						<c:forEach var="qboardDTO" items="${QboardSearchDTOList}"
							varStatus="stat">
							...
							<div class="title">
								<a
									href="${webapproot}/qboardview.do?qPostingID=${qboardDTO.qPostingID}">${qboardDTO.title}</a>
							</div>
				...
				<div class="board_page">
					...
					<c:if test="${pn1 eq 'a'}">
						<a
							href="${webapproot}/qboardsearchlistform.do?pageNumber=${pageNumber-1}"
							class="bt prev"><</a>
					</c:if>
					<c:if test="${pn2 eq 'b' }">
						<a
