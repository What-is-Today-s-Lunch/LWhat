	...
	<div class="main_text0">
		...
		<ul class="icons">
			<li>
				...
				<div class="more">
					<a href="#"
						onclick="location.href='${webapproot}/restaurantform.do?category=A1AA'">MORE</a>
				</div>
			</li>
			...
			<li>
				...
				<div class="more">
					<a href="#"
						onclick="location.href='${webapproot}/restaurantform.do?category=A1AC'">MORE</a>
				</div>
			</li>
			...
			<li>
				...
				<div class="more">
					<a href="#"
						onclick="location.href='${webapproot}/restaurantform.do?category=A1AB'">MORE</a>
				</div>
			</li>
			...
			<li>
				...
				<div class="more">
					<a href="#"
						onclick="location.href='${webapproot}/restaurantform.do?category=A1AE'">MORE</a>
				</div>
			</li>
			...
			<li>
				...
				<div class="more">
					<a href="#"
						onclick="location.href='${webapproot}/restaurantform.do?category=A1AD'">MORE</a>
				</div>
			</li>
			...
			<li>
				...
				<div class="more">
					<a href="#"
						onclick="location.href='${webapproot}/restaurantform.do?category=A1AZ'">MORE</a>
				</div>
			</li>
