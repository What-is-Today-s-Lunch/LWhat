					...
					<div class="board_list_wrap">
						<div class="board_list">
							...
							<c:forEach var="qboardDTO" items="${list}" varStatus="stat">
								...
								<div class="title"><a href="${webapproot}/qboardview.do?qPostingID=${qboardDTO.qPostingID}">${qboardDTO.title}</a></div>
						...
						<c:if test="${pn1 eq 'a'}">
							<a href="${webapproot}/qboardlist.do?pageNumber=${pageNumber-1}" class="bt prev"><</a>
						</c:if>
						<c:if test="${pn2 eq 'b' }">
							<a href="${webapproot}/qboardlist.do?pageNumber=${pageNumber+1}" class="bt next">></a>
						</c:if>
						</div>
						<div class="bt_wrap">
