...
public class RestaurantListDAOImpl extends AbstractRestaurantDAOImpl {
	...
	public List<RestaurantDTO> listRestaurant(String code) throws Exception {
		...
		PreparedStatement pstmt = conn
				.prepareStatement(RestaurantConstants.restaurant.getProperty("RESTAURANT_LIST_SEARCH_SQL"));
		PreparedStatement pstmt2 = conn
				.prepareStatement(RestaurantConstants.restaurant.getProperty("RESTAURANT_REVIEW_SCORE_SQL"));
